...
**Estado corrente levantado em 2026-09-02, contra a `main` em `3a571c2`.**
...
| 3 | **`feat/questionario-pat-time`** — questionário e acompanhamento por PAT | 🔴 em implementação; parar antes do merge |
